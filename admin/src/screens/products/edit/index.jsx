...
export default function EditProductScreen({ productId }) {
  ...
  const removeVariantRow = (index) => {
    ...
    setFormData((prev) => ({
      ...prev,
      variants: updatedVariants.length ? updatedVariants : [{ ...emptyVariant }],
    }));
  };
  ...
  const handleVariantImageUpload = async (index, file) => {
    ...
    try {
      ...
      if (uploadRes.ok && uploadResult.success) {
        handleVariantChange(index, "imageUrl", uploadResult.imageUrl);
      } else {
        alert(uploadResult.message || "Variant image upload failed");
      }
    } catch (error) {
    ...
    <div className="product-form-page">
      <div className="product-form-card">
        ...
        <form onSubmit={handleSubmit} className="product-form">
          ...
          <div className="product-field">
            <label className="product-label">Upload New Main Image</label>
            <input
              className="product-input"
              type="file"
              accept="image/*"
          ...
          {formData.imageUrl ? (
            <div className="product-field">
              <label className="product-label">Main Image Preview</label>
              <img
